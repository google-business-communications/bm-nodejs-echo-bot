...
router.post('/callback', function(req, res, next) {
  ...
  let googleSignature = req.headers['x-goog-signature'];

  if (generatedSignature === googleSignature) {
    console.log("Signature match.");
  } else {
    console.log("Signature mismatch, do not trust this message.");
  }

  console.log("x-goog-signature: " + googleSignature);
